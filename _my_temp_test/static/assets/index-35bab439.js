...
(function() {
    ...
    new MutationObserver(r => {
        for (const R of r)
            if (R.type === "childList")
                for (const n of R.addedNodes) n.tagName === "LINK" && n.rel === "modulepreload" && t(n)
    }).observe(document, {
        childList: !0,
        subtree: !0
    });
...
async function uT(E) {
    ...
    let r;
    if (e.function_generation && t.type === "function") Se(t), r = t.id, GE.set(t.id), Et.set(t.function.instantiated_sql);
    else {
...
function Mn(E) {
    window.location.hash = E, DE.set("chat"), UR(), Ht.set(!0), Pe("load_question", "GET", {
        id: E
    }).then(Se)
}
...
async function Pe(E, e, T) {
    try {
        ...
        let t = "",
            r;
        if (e === "GET") t = Object.entries(T).filter(([n, s]) => n !== "endpoint" && n !== "addMessage").map(([n, s]) => `${encodeURIComponent(n)}=${encodeURIComponent(s)}`).join("&"), r = await fetch(`/api/v0/${E}?${t}`);
        else {
...
function Xn(E) {
    let e, T, t, r, R, n, s, S, A, o, i, _, c, P, p, C, L, I, u, H, b, M = E[0].version + "",
            ...
            var T = {
                    661: (n, s, S) => {
                        ...
                        var P = function(p) {
                            ...
                            }]) && o(C.prototype, L), Object.defineProperty(C, "prototype", {
                                writable: !1
                            }), b
                        }(S(765).Z);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
                            ...
                            }]) && i(L.prototype, I), Object.defineProperty(L, "prototype", {
                                writable: !1
                            }), M
                        }(S(765).Z);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
                        ...
                        var u = function(H) {
                            ...
                            }], M && p(b.prototype, M), Object.defineProperty(b, "prototype", {
                                writable: !1
                            }), B
                        }(o.Z);
                    ...
                    284: (n, s, S) => {
                        ...
                        var p = function(C) {
                            ...
                            return L = M, (I = [{
                                ...
                                value: function(O) {
                                    var N, D = this,
                                        B = O.getAttribute("data-hs-overlay-backdrop-container") || !1,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
                        ...
                        var C = function(L) {
                            ...
                            }]) && _(I.prototype, u), Object.defineProperty(I, "prototype", {
                                writable: !1
                            }), O
                        }(S(765).Z);
                    ...
                    765: (n, s, S) => {
                        ...
                        var o = function() {
                            ...
                            }], c && A(_.prototype, c), Object.defineProperty(_, "prototype", {
                                writable: !1
                            }), i
                        }()
                    },
                    714: (n, s, S) => {
                        ...
                        function MT(U, d) {
                            return d === dE ? Bt(function(g) {
                                ...
                                var w, Z = u(g),
                                    q = L(g),
                                    Q = (w = g.ownerDocument) == null ? void 0 : w.body,
                        ...
                        var tn = ME({
                            defaultModifiers: [{
                                ...
                                effect: function(U) {
                                    ...
                                    return Object.assign(d.elements.popper.style, g.popper), d.styles = g, d.elements.arrow && Object.assign(d.elements.arrow.style, g.arrow),
                                        function() {
                                ...
                                fn: function(U) {
                                    ...
                                    if (le) {
                                        if (q) {
                                            var lE, PE = he === "y" ? x : z,
                                                SE = he === "y" ? J : oe,
                                                tE = he === "y" ? "height" : "width",
                                                xe = le[he],
                                                Be = xe + ie[PE],
                                                UE = xe - ie[SE],
                                                oE = ae ? -pe[tE] / 2 : 0,
                                                RE = be === ye ? fe[tE] : pe[tE],
                                                _E = be === ye ? -pe[tE] : -fe[tE],
                                                $E = d.elements.arrow,
                                                mE = ae && $E ? N($E) : {
                                                    width: 0,
                                                    height: 0
                                ...
                                fn: function(U) {
                                    var d, g = U.state,
                                        ...
                                        Z = U.options,
                                        q = g.elements.arrow,
                                        Q = g.modifiersData.popperOffsets,
                                        ee = ze(g.placement),
                                        Ee = Fe(ee),
            ...
            r.d = (n, s) => {
                for (var S in s) r.o(s, S) && !r.o(n, S) && Object.defineProperty(n, S, {
                    enumerable: !0,
                    get: s[S]
                })
...
function oA(E, e, T) {
    ...
    function R() {
        if (T(0, r = !0), pR.set(!0), "webkitSpeechRecognition" in window) var n = new window.webkitSpeechRecognition;
...
function gA(E, e, T) {
    let {
        fig: t
    } = e, r = JSON.parse(t), R = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
    return DR(() => {
...
var BR = Object.defineProperty,
    ...
    ts = (E, e) => {
        ...
        if (E != null && Mt)
            for (var t of Mt(E)) e.indexOf(t) < 0 && FR.call(E, t) && (T[t] = E[t]);
        return T
    },
    Ts = (E, e) => {
...
function Ps(E) {
    let e = tt;
    return E.map(T => T.text === "OFFSET" && e.text === "[" ? (e = T, AE(EE({}, T), {
...
function ai(E) {
    let e, T, t, r, R, n, s, S, A, o, i, _, c, P, p, C, L, I, u, H, b, M, O, N, D, B = De(E[1].arguments),
        h = [];
...
function ua(E) {
    let e, T, t, r, R, n, s, S, A, o, i, _, c, P, p, C, L, I, u, H, b, M, O, N, D, B = De(E[3]),
        h = [];
...
function Ma(E) {
    let e, T, t, r, R, n, s, S, A, o, i, _, c, P, p, C, L, I, u, H, b, M, O, N, D, B, h, G = E[2] + 1 + "",
...
function Ua(E, e, T) {
    ...
    } = e, n = JSON.parse(t), s = n.length > 0 ? Object.keys(n[0]) : [], S = 10, A = 1, o = Math.ceil(n.length / S), i = (A - 1) * S, _ = A * S, c = n.slice(i, _);
    const P = () => {
            A > 1 && T(16, A--, A)
        },
        p = () => {
